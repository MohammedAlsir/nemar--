...
trait Oprations
{
     ...
     *
     */
    public function create_date_with_two_model($pagePath, $model_1, $model_2)
    {
        $model_1 = $model_1::orderBy('id', 'DESC')->get();
        $model_2 = $model_2::orderBy('id', 'DESC')->get();
        return view($pagePath, compact('model_1', 'model_2'));
    }
    ...
    /**
     * دالة فتح صفحة التعديل للعنصر المطلوب مع جلب بيانات موديلين
     *
     * $model_1           =>  المودل1
     * $model_2           =>  2المودل
     * $id              => رقم العنصر
     ...
     *
     */
    public function edit_data_with_two_model($model, $id, $model_1, $model_2, $pagePath)
    {
        $item = $model::find($id);
        $model_1 = $model_1::orderBy('id', 'DESC')->get();
        $model_2 = $model_2::orderBy('id', 'DESC')->get();
        return view($pagePath, compact('item', 'model_1', 'model_2'));
    }
